...
var settings = {
  particles: {
    ...
    velocity: 260, // particle velocity in pixels/sec
...
//等待加载
	...
	$(document).ready(function(){
		$("#x").click(function(){
			$("#loader-wrapper #pinkboard").fadeToggle(3000);
			setTimeout(function(){$("#loader-wrapper #pinkboard").fadeToggle(3000);},"3000");
		});
	});
});